...
<body style="background-color: silver">
    <div style="width: 70%; background-color: white; margin: 10px auto; padding: 20px;">
        <h1 style="text-align: center">Input Data Pasien Virus Covid19</h1>
        <hr>
        <form action="db.php" method="POST">
            ...
            <div>
                ...
                <button onclick="window.location.href='input.php'" style="margin-top: 15px; height: 40px; background-color: red; color: white;">BATAL</button>
            </div>
